...
export const AnimatedBackground = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      />
      <motion.div
        className="absolute top-1/2 right-1/4 w-96 h-96 bg-cyber-purple/20 rounded-full blur-3xl"
        animate={{
          x: [0, -100, 0],
          y: [0, 100, 0],
          scale: [1, 1.3, 1],
      ...
      />
      <motion.div
        className="absolute bottom-1/4 left-1/2 w-96 h-96 bg-cyber-pink/20 rounded-full blur-3xl"
        animate={{
          x: [0, 50, 0],
          y: [0, -100, 0],
          scale: [1, 1.1, 1],
